								...
								<div className="row my-4 d-sm-block d-md-flex justify-content-between text-center">
									<div className="col-lg-3 col-md-3 col-sm-6 px-0 mx-3">
										...
										<p className="profile-name text py-2 px-3 mb-5">
											<strong>Welcome, {store.displayName}!</strong>
										</p>
									</div>
									...
									<div className="col-sm-6 col-md-2 text-center">
										<Link to="/">
											<button
												...
												onMouseDown={e => actions.logOutUser(e)}
												onMouseUp={e => this.logOutRedirect(e)}>
												Log Out
											</button>
										</Link>
									</div>
					...
					<div className="container mb-5">
						...
						<div className="card-deck mb-5">
							<div className="card">
								...
								<div className="card-body">
									...
									<p className="card-text">
										The main tourist attractions are popular for a reason. While getting off the
										beaten track can be fun, the things you’ll see are rarely as impressive as the
										popular sights. Don’t be a travel snob — hit up the famous stops as well as the
							...
							<div className="card">
								...
								<div className="card-body">
									...
									<p className="card-text">
										Working as professional photographer for the past 12 years, I’ve come up with
										the ultimate kit for travel photography. This travel photography packing list
										includes all of the gear you’ll need and the best camera backpacks for travel
										photographers. Here’s how to pack like a pro!
									</p>
								</div>
								<div className="card-footer">
									<p>Check the rest of this article on:</p>
							...
							<div className="card">
								...
								<div className="card-body">
									...
									<p className="card-text">
										After traveling to Europe for the past 20 years, I’ve learned all of the best
										tips and tricks. These Europe travel tips cover everything you NEED to know!
									</p>
								</div>
								<div className="card-footer">
									<p>Check the rest of this article on:</p>
						...
						<div className="card-deck mb-5">
							<div className="card">
								<div className="card-body">
									<h5 className="card-title">
										<strong>Current Local Times Around the World:</strong>
									</h5>
